                            ...
                            <tbody>
                                ...
                                @foreach ($customers as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.customer_view_invoice',$row->id)}}" type="button"
                                                class="badge badge-xs badge-info fw-600 text-xs">
                                                {{ $lang->data['view_customer'] ?? 'View Customer' }}
                                            </a>
                                            <a href="{{route('admin.customer_ledger',$row->id)}}" type="button"
