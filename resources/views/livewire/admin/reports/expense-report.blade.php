            ...
            <div class="card-body p-0">
                    ...
                    <table class="table table-bordered align-items-center mb-0 ">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 20%" >
                                    <p class="text-xs px-3 font-weight-bold mb-0">{{getFormattedCurrency($row->expense_amount)}}</p>
                                </td>
                                <td style="width: 15%" >
                ...
                <div class="row align-items-center px-4 mb-3">
                    ...
                    <div class="col">
                        ...
                        <span class="text-sm text-dark ms-2 fw-600 mb-0">{{getFormattedCurrency($expenses->sum('expense_amount'))}}</span>
                    </div>
                    <div class="col">
                        <span class="text-sm mb-0 fw-500">{{$lang->data['total_tax_amount'] ?? 'Total Tax Amount'}}:</span>
                        <span class="text-sm text-dark ms-2 fw-600 mb-0">{{getFormattedCurrency($tax_amount_total)}}</span>
                    </div>
                    <div class="col-auto">
