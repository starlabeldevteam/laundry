            ...
            <div class="card-body p-0">
                    ...
                    <table class="table table-bordered align-items-center mb-0 ">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 14%" >
                                    <p class="text-xs px-3 font-weight-bold mb-0">{{getFormattedCurrency($row->sub_total)}}</p>
                                </td>
                                <td style="width: 14%" >
                                    <p class="text-xs px-3 font-weight-bold mb-0">{{getFormattedCurrency($row->addon_total)}}</p>
                                </td>
                                <td style="width: 14%" >
                                    <p class="text-xs px-3 font-weight-bold mb-0">{{getFormattedCurrency($row->discount)}}</p>
                                </td>
                                <td style="width: 14%" >
                                    <p class="text-xs px-3 font-weight-bold mb-0">{{getFormattedCurrency($row->tax_amount)}}</p>
                                </td>
                                <td style="width: 15%" >
                                    <p class="text-xs px-3 font-weight-bold mb-0">{{getFormattedCurrency($row->total)}}</p>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="row align-items-center px-4 mb-3">
                    ...
                    <div class="col">
                        ...
                        <span class="text-sm text-dark ms-2 fw-600 mb-0">{{getFormattedCurrency($orders->sum('total'))}}</span>
                    </div>
                    <div class="col">
                        <span class="text-sm mb-0 fw-500">{{$lang->data['total_tax_amount'] ?? 'Total Tax Amount'}}:</span>
                        <span class="text-sm text-dark ms-2 fw-600 mb-0">{{getFormattedCurrency($orders->sum('tax_amount'))}}</span>
                    </div>
                    <div class="col-auto">
